...
- GitHub Actions workflow 已配置 Core、CLI SwiftPM 测试和 Xcode arm64 build/test；重要性中高，代码已完成但仍需下一次 push/PR 的远程 run 作为最终证据。本地镜像已通过 YAML、Core、CLI、CLI build、Xcode build；Xcode test 使用 `CODE_SIGNING_ALLOWED=YES CODE_SIGN_IDENTITY=-`。
