# Hiko-VoiceConvert v1.1.1

## Highlights

- Three equal macOS workflows: audio conversion, WebVTT to LRC, and audio/subtitle pairing.
- Real-time audio conversion progress shows batch completion, current file, per-item status, and percentages.
...
- Xcode arm64 Debug build and test passed.
...
`Hiko-VoiceConvert-v1.1.1-macos-arm64.zip` contains:
...
- macOS 26.0 or newer.
- Apple Silicon arm64.
- This archive is ad-hoc signed but NOT Developer-ID signed or notarized. Gatekeeper may require manual approval.
